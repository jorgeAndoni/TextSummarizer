...
class Summarizer(object):
    ...
    def execute(self):
        ...
        obj = Loader(language=language, type_summary=type_summary, corpus=corpus_name, mln=mln_type_flag)
    ...
    def parse_file(self, file):
        ...
        #dictionary['network'] = ('mln', ['tfidf', [1.9], [0.5]])
        ...
        dictionary['measures'] = ['sym_l_b_h2']
