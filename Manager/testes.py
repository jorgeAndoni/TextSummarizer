...
from configuration import some_parameters


train_command = './fasttext skipgram -input ' + some_parameters['train_file'] + ' -output model'
os.system(train_command)
#command = "./fasttext print-sentence-vectors model.bin < text.txt"
command = './fasttext print-sentence-vectors model.bin < '  +   some_parameters['train_file']
print command
os.system(command)
...
train_file = some_parameters['train_file']

#model = fasttext.skipgram(train_file, 'model2')
#print model.words
#print model[u'unica']

model = fasttext.load_model('model2.bin')
lista = model.words # list of words in dictionary
#print model[u'unica'] # get the vector of the word 'king'
for i in lista:
    print model[i]
